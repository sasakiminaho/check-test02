...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => asset('img/strawberry.webp'),
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => asset('img/watermelon.webp'),
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => asset('img/pineapple.webp'),
